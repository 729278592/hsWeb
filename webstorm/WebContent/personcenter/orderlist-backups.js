...
function showAll(pageNow){
	...
	$("#nomsg").remove();
	$("#place"+place).css("border-bottom","2px solid #ff620d");
	$("#place"+place+" a").css("color","#ff620d");
				...
				$.post("../order/onegood.do?orderId="+orderId,function(obj2){
					if(obj2 && obj2.good){
						...
						if(o.m_statu=="1"){
							...
							$("#bon"+o.m_id).append($("<a href='#' onclick='noShow("+o.m_id+")' class='hide"+o.m_id+"'><span  class='lost' style='text-align: center;line-height: 2.4rem;font-size: 1.2em;margin-right:3%;display:inline-block;width:7rem;float:right;height:2.5rem;border-radius:35px;background: #ffffff;color:#505050;border:1px solid #868686;text-align: center;font-size: 1.2em;margin-right: 3%;'>取消订单</span></a><a href='javascript:void(0);' class='hide"+o.m_id+"' onclick='toPay("+o.m_id+","+obj2.good.m_good_id+")'><span class='paymoney' style='display:inline-block;width:7rem;float:right;height:2.5rem;border:1px solid #ff620d;background:#ff620d;border-radius:35px;color:#fff;text-align: center;line-height: 2.4rem;font-size: 1.2em;margin-right: 3%;text-align: center;font-size: 1.2em;margin-right: 3%;'>去支付</span></a>"))
						}else if(o.m_statu=="2" || o.m_statu=="1.1"){
							$("#stas"+o.m_id).html("待收货");
							if(o.m_statu=="2" ){
								$("#bon"+o.m_id).append($("<a href='javascript:qrsh("+o.m_id+");' ><span class='paymoney' style='display:inline-block;text-align:center;width:7rem;margin-bottom:1em;float:right;height:2.5rem;line-height:2.4rem;border:1px solid #ff620d;background:#ff620d;border-radius:35px;color:#fff;font-size:1.2em;margin-right:3%;'>确认收货</span></a>"));
							}else{
								$("#bon"+o.m_id).hide();
							}
						}else if(o.m_statu=="3"){
							$("#stas"+o.m_id).html("等待评价");
							$("#bon"+o.m_id).append($("<a href='#' id='post"+o.m_id+"' onclick='toPost("+o.m_id+","+o.m_onlineOff+")'><span  class='paymoney' style='text-align: center;line-height: 2.4rem;font-size: 1.2em;margin-right: 3%;display:inline-block;width:7rem;float:right;height:2.5rem;border:1px solid #ff620d;background:#ff620d;border-radius:35px;color:#fff;text-align: center;font-size: 1.2em;margin-right: 3%;'>去评论</span></a>"));
						}else if(o.m_statu=="4"){
