...
$(function() {
    ...
    core.requireJS(['../js/jweixin-1.0.0.js', '../js/mpAPI.js'], function() {
        ...
        mp.oAuthAPI(function(data) {
            ...
            var payData = JSON.stringify({"fromUid":fromId,"relId":id,"type":"shop"});
            $.ajax({
						 type: "POST",
					     url: sh_url,
            ...
            mp.jsAPI(function() {
                ...
                var shareURL = staticServicePath + '/secondbkAll.html?fId=' + fromId + '&t='+t +'&showUrl='+ encodeURIComponent(showUrl) + "&type=" + share_type_store;
                ...
                wx.onMenuShareTimeline({
                    ...
                    success: function () {
                        ...
                        // }
                        $.post(partnerServerPath + "/share/add.do?type=shop&id="+id,function(obj){
