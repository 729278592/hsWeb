...
function _init_area(){  //初始化函数
	for(q=0;q<dsy.Items["0"].length;q++){
		$("#s_province").append($("<option value='"+q+"'>"+dsy.Items["0"][q]+"</option>"));
	}
}
function changeCity(citynum){
	...
	for(q=0;q<dsy.Items["0_"+i].length;q++){
		$("#s_city").append($("<option value='"+q+"'>"+dsy.Items["0_"+i][q]+"</option>"));
	}
}
function changeTown(townnum){
	$("#s_county option").remove();
	j=townnum;
	for(q=0;q<dsy.Items["0_"+i+"_"+j].length;q++){
		$("#s_county").append($("<option>"+dsy.Items["0_"+i+"_"+j][q]+"</option>"));
	}
}
...
$(function(){
	...
	$("#s_province").change(function(){
		changeCity($("#s_province").val());
		changeTown($("#s_city").val());
	});
